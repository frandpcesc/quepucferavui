...
$("form.container").on("submit", function(e) {
	...
	var ok = true; 	
	// franja horària
	if ($("form.container #horari").val().length < 1) {
		$("form.container #horari").siblings('obligatori').html("<span>Camp obligatori!</span>");
		ok = false;
	} else {
		$("form.container #horari").siblings('obligatori').html("<obligatori></obligatori>");
	}
	// posició
